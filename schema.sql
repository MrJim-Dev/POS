...
-- Join orders, order_details, and products to view complete order information
-- SELECT orders.order_id, customers.name AS customer_name, products.name AS product_name, order_details.quantity, order_details.line_total 
-- FROM orders 
