...
<body>
                ...
                <div class="form-group">
                  ...
                  <select name="supplier" class="form-control" id="supplier">
                    ...
                    foreach ($suppliers as $supplier) {
                      $i++;
                      echo '
                        <option value="' . $supplier['supplier_id'] . '">' . $supplier['name'] . ' (' . $supplier['contact_name'] . ')</option>
                      ';
                    } ?>
                  </select>
                </div>
  ...
  <script>
    $('[submitBtn]').on('click', function(event) {
      ...
      $.ajax({
        type: "POST",
        url: "http://pospal.jimtech.solutions:5000//inventory",
        ...
        success: function(response) {
          ...
          if (response != null) {
            $('#alertmsg').html('<div class="alert alert-success mb-3" role="alert">The supplier was successfully added. Reloading the page in 3 seconds.</div>');
