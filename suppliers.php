...
<head>
  ...
  <title><?php echo SITE_NAME; ?> - Suppliers</title>
  <!-- Favicon -->
...
<body>
            ...
            <div class="card-header border-0">
              <div class="row align-items-center">
                ...
                <div class="col text-right">
                  <button class="btn btn-sm btn-primary" toggleAddModal>Add Supplier</button>
                </div>
              </div>
            </div>
                    ...
                    <tr>
                      ...
                      <td class="text-right">
                        <div class="dropdown">
                          ...
                          <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow" uid="' . $row['supplier_id'] . '">
  ...
  <script>
    ...
    $('[addModalSubmit]').on('click', function(event) {
      ...
      $.ajax({
        type: "POST",
        url: "http://http://pospal.jimtech.solutions:5000//suppliers",
    ...
    $('[toggleEditModal]').on('click', function() {
      ...
      $('[editModalSubmit]').on('click', function() {
        ...
        $.ajax({
          type: "PUT",
          url: `http://http://pospal.jimtech.solutions:5000//suppliers/${uid}`,
          data: JSON.stringify(formData), // Convert formData to a JSON string
          contentType: "application/json", // Set content type to JSON
          dataType: "json", // Expect a JSON response
          success: function(response) {
